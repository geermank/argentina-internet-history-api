export default function handler(req, res) {
    const firstParagrap = "Even though our journey starts in 1994, we have to first go a bit back in time. In particular to the year 1987," +
    ...
    const response = {
        pageTitle: "The history of the Internet in Argentina",
        content: [
            {
                type: "navbar",
                data: {
